...
exports.match.round.add = function (id_match, score_player_1, score_player_2, naut_player_1, naut_player_2, cb) {
    helper.mysql.connection(function (err, connection) {
        if (!err) {
            connection.query('INSERT INTO `round` SET ?', {id_match: id_match, score_player_1: score_player_1, score_player_2: score_player_2, naut_player_1: naut_player_1, naut_player_2: naut_player_2}, function (err, rows) {
                console.log(err);
                cb();
            });
        }
